...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="probootstrap-navbar">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a class="nav-link" href="#section-features">Destaques</a></li>
            <li class="nav-item"><a class="nav-link" href="#section-pricing">Níveis de Acesso</a></li>
    ...
    <section class="pb_cover_v3 overflow-hidden cover-bg-indigo cover-bg-opacity text-left pb_gradient_v1 pb_slant-light" id="section-home">
      <div class="container">
        <div class="row align-items-center justify-content-center">
          <div class="col-md-6">
            <h2 class="heading mb-3">Conheça o Lambda</h2>
            <div class="sub-heading">
              <p class="mb-4">Sistema de gestão empresarial para pequenas empresas. Funcionalidades de CRM e HRM.</p>
          ...
          <div class="col-md-5 relative align-self-center">
            ...
            <form action="#" class="bg-white rounded pb_form_v1">
              ...
              <div class="form-group">
                <input type="text" class="form-control pb_height-50 reverse" placeholder="Senha">
              </div>
  ...
  <!--
    ...
    <section class="pb_section pb_slant-light pb_pb-200" id="section-pricing">
      <div class="container">
        <div class="row justify-content-center mb-5">
          <div class="col-md-6 text-center mb-5">
