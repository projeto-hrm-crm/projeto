...
<?php endif;?>
<div class="default-tab" role="content" aria-label="Aqui você pode escolher entre ver informações do módulos HRM ou CRM">
  <nav role="navigation">
    <div class="nav nav-tabs" id="nav-tab" role="tablist">
      <a class="nav-item nav-link  active show" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-label="Aqui você seleciona as informações de ambito da Gestão Empresarial" aria-controls="nav-home" aria-selected="true">Gestão empresarial</a>
      <a class="nav-item nav-link" id="nav-profile-tab" data-toggle="tab" href="#nav-profile" role="tab" aria-label="Aqui você seleciona as informações de ambito da Gestão de Recursos Humanos"  aria-controls="nav-profile" aria-selected="false">Gestão de recursos humanos</a>
    </div>
  </nav>
