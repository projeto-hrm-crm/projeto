            ...
            <div class="card-body">
              ...
              <br />
                ...
                <?php
                  ...
                  $attr     = [
                    'id'    => 'id',
                    'href'  => site_url('SAC/editar/'.$sac[0]->id_sac),
                    'title'       => 'Atualizar SAC',
                  ];
                ...
                <?php
                  $type           = "a";
                  $label          = "<span class='fa fa-comment-o'></span>";
                  $classes        = ['btn', 'btn-success'];
                  $attr           = [
                    'id'          => 'id',
                    'href'        => site_url('SAC/iterar/'.$sac[0]->id_sac),
                    'title'       => 'Iteração'
                  ];
                  if (!is_null($iterate_button))
                    $iterate_button->build($type, $label, $classes, $attr);
                ?>
              </td>
                                </tr>
                            <?php endforeach; ?>
