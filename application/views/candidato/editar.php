        ...
        <div class="card-body">
          ...
          <form action="<?php site_url('candidato/edit'.$id); ?>" method="POST" class="form-horizontal">
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9"><input type="text" id="nome" name="nome" class="form-control" value="<?= htmlspecialchars($candidato[0]->nome)?>" title="Campo obrigatório" required></div>
            </div> <!-- FIM NOME -->
            <div class="row form-group">
              <div class="col col-md-3"><label for="email-input" class=" form-control-label">Email</label></div>
              <div class="col-12 col-md-9"><input type="text" id="email" name="email" value="<?= htmlspecialchars($candidato[0]->email)?>" class="form-control" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,6}$" title="Digite um e-mail válido" required></div>
            </div> <!-- FIM EMAIL -->
            <div class="row form-group">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9">
                ...
                <input type="radio" name="sexo" id="sexo_fem" value="1" <?php echo ($candidato[0]->sexo=='1')?'checked':'' ?> /><label for="sexo_fem">Feminino</label></div>
              </div> <!-- FIM SEXO -->
              <div class="row form-group">
              ...
              <div class="row form-group">
                ...
                <div class="row form-group">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="logradouro" id="logradouro" name="logradouro"  value="<?= htmlspecialchars($candidato[0]->logradouro)?>"  placeholder="Rua/Av./Praça/Alameda/Travessa" class="form-control" pattern="[A-Za-z]" title="Campo obrigatório" required></div>
                  </div> <!-- FIM ENDEREÇO -->
                  <div class="row form-group">
                    <div class="col col-md-3"><label class=" form-control-label">Número</label></div>
                    <div class="col-12 col-md-9"><input type="numero" id="numero" name="numero" value="<?= htmlspecialchars($candidato[0]->numero)?>"  placeholder="Número da casa" class="form-control" pattern="[0-9]" title="Campo obrigatório" required></div>
                  </div> <!-- FIM NÚMERO -->
                  <div class="row form-group">
                    <div class="col col-md-3"><label class=" form-control-label">Complemento</label></div>
                    <div class="col-12 col-md-9"><input type="complemento" id="complemento" name="complemento" value="<?= htmlspecialchars($candidato[0]->complemento)?>" placeholder="Complemento" class="form-control" title="Campo opcional" ></div>
                  </div> <!-- FIM COMPLEMENTO -->
                  <div class="row form-group">
                    <div class="col col-md-3"><label class=" form-control-label">Bairro</label></div>
                    <div class="col-12 col-md-9"><input type="bairro" id="bairro" name="bairro" value="<?= htmlspecialchars($candidato[0]->bairro)?>"  placeholder="Bairro" class="form-control" title="Campo obrigatório" required></div>
                  </div> <!-- FIM BAIRRO -->
                  <div class="row form-group">
                  ...
                  <div class="row form-group">
                    <div class="col col-md-3">
                      <label for="vaga">Vagas disponíveis</label></div>
                      <div class="col-12 col-md-9">
