                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6 col-sm-12">
                                ...
                                <input id="valor_produto" value="<?php echo isset($old_data['valor_produto']) ? $old_data['valor_produto'] : null;?>" name="valor" type="text" class="form-control <?php echo isset($errors['valor_produto']) ? 'is-invalid' : '' ?>" required>
