                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-6">
                                ...
                                <input id="nome" value="<?php echo isset($old_data['nome']) ? $old_data['nome'] : null;?>" name="nome" type="text" class="form-control" required>
                                <span class="invalid-feedback">Nome inválido.</span>
                            </div>
                            <div class="form-group col-6">
                                <label for="lote" class="control-label mb-1">Lote</label>
                                <input id="lote" value="<?php echo isset($old_data['lote']) ? $old_data['lote'] : null;?>" name="lote" type="text" class="form-control" required>
                                <span class="invalid-feedback">Lote inválido.</span>
                            </div>
                            <div class="form-group col-6">
                                <label for="codigo" class="control-label mb-1">Código</label>
                                <input id="codigo" value="<?php echo isset($old_data['codigo']) ? $old_data['codigo'] : null;?>" name="codigo" type="text" class="form-control" required>
                                <span class="invalid-feedback">Código inválido.</span>
                            </div>
                            <div class="form-group col-6">
                                <label for="recebimento" class="control-label mb-1">Data de Recebimento</label>
                                <input id="recebimento" value="<?php echo isset($old_data['recebimento']) ? $old_data['recebimento'] : null;?>" name="recebimento" type="text" class="form-control data" required>
                            ...
                            <div class="form-group col-6">
                                ...
                                <input id="fabricacao" value="<?php echo isset($old_data['fabricacao']) ?  $old_data['fabricacao'] : null;?>" name="fabricacao" type="text" class="form-control data" required>
