   ...
   <section id="home" data-parallax="scroll" data-image-src="<?php echo base_url();?>assets/landing_page/images/hero-bg.jpg" data-natural-width=3000 data-natural-height=2000>
        ...
        <div class="home-content">        
            ...
            <div class="row contents">                     
                <div class="home-content-left">
                    ...
                    <h3 data-aos="fade-up">A aplicação simples e fácil para</h3>
                    ...
                    <div class="buttons" data-aos="fade-up">
                        <a href="#sobre" class="smoothscroll button stroke">
    ...
    <section id="acesso">
        <div class="row acesso-content">
            ...
            <div class="col-eight acesso-table">
                <div class="row">
                    ...
                    <div class="col-six plan-wrap">
                        <div class="plan-block" data-aos="fade-up"> 
                            ...
                            <div class="plan-top-part">
                                <h3 class="plan-block-title">Cliente</h3>
                            </div>
                    ...
                    <div class="col-six plan-wrap">
                        <div class="plan-block primary" data-aos="fade-up">
                            ...
                            <div class="plan-top-part">
                                <h3 class="plan-block-title">Administrador</h3>
                            </div>
