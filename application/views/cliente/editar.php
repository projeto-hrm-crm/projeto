        ...
        <div class="card-body">
          ...
          <form action="<?php site_url('cliente/edit'.$id); ?>" method="POST" class="form-horizontal">
            ...
            <div class="row form-group">
              ...
              <div class="col-12 col-md-9"><input type="text" id="data_nascimento" name="data_nascimento" value="<?= htmlspecialchars($cliente[0]->data_nascimento)?>" class="form-control data" required></div>
            ...
            <div class="row form-group">
              ...
              <div class="row form-group">
                ...
                <div class="col-12 col-md-9"><input type="text" id="cpf" name="cpf" value="<?= htmlspecialchars($cliente[0]->numero_documento)?>" class="form-control cpf" pattern="[0-9]{11}" title="O CPF deve conter 11 dígitos decimais" ></div>
              </div> <!-- FIM CPF -->
              <div class="row form-group">
                <div class="col col-md-3"><label class=" form-control-label">Telefone</label></div>
                <div class="col-12 col-md-9"><input type="text" id="telefone" name="tel" value="<?= htmlspecialchars($cliente[0]->telefone)?>" class="form-control telefone" pattern="[0-9]{11}" title="Insira um número válido de telefone" ></div>
              </div> <!-- FIM TELEFONE -->
              ...
              <div class="row form-group">
                ...
                <div class="row form-group">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="logradouro" id="logradouro" name="logradouro"  value="<?= htmlspecialchars($cliente[0]->logradouro)?>"  placeholder="Rua/Av./Praça/Alameda/Travessa" class="form-control" pattern="[A-Za-z]" title="Campo obrigatório" required></div>
                  </div> <!-- FIM ENDEREÇO -->
                  <div class="row form-group">
                  ...
                  <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="complemento" id="complemento" name="complemento" value="<?= htmlspecialchars($cliente[0]->complemento)?>" placeholder="Complemento" class="form-control" title="Campo opcional" ></div>
                  </div> <!-- FIM COMPLEMENTO -->
                  <div class="row form-group">
                    <div class="col col-md-3"><label class=" form-control-label">Bairro</label></div>
                    <div class="col-12 col-md-9"><input type="bairro" id="bairro" name="bairro" value="<?= htmlspecialchars($cliente[0]->bairro)?>"  placeholder="Bairro" class="form-control" title="Campo obrigatório" required></div>
                  </div> <!-- FIM BAIRRO -->
                  <div class="row form-group">
                    <div class="col col-md-3"><label class=" form-control-label">CEP</label></div>
                    <div class="col-12 col-md-9"><input type="cep" id="cep" name="cep" value="<?= htmlspecialchars($cliente[0]->cep)?>"  placeholder="C.E.P" class="form-control cep" title="Campo obrigatório" required></div>
