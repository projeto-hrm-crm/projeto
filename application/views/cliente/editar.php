              ...
              <div class="card-body">
                ...
                <form action="<?php site_url('cliente/edit'.$id); ?>" method="POST" class="form-horizontal">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9"><input type="cep" id="cep" name="cep" value="<?= htmlspecialchars($cliente[0]->cep)?>"  placeholder="C.E.P" class="form-control" title="Campo obrigatório" data-mask="00000-000" required></div>
