      ...
      <div class="card">
        ...
        <form action="<?php site_url('cliente/edit'.$id); ?>" method="POST" class="form-horizontal">
          <div class="card-body card-block">
            <div class="row">
              <div class="form-group col-12 col-md-6">
                ...
                <input type="text" id="nome" name="nome" class="form-control" value="<?= htmlspecialchars($cliente[0]->nome)?>" title="Campo obrigatório" required>
              </div> <!-- FIM NOME -->
              <div class="form-group col-12 col-md-6">
              ...
              <div class="form-group col-12 col-md-6">
                ...
                <input type="text" id="data_nascimento" name="data_nascimento" value="<?= htmlspecialchars($cliente[0]->data_nascimento)?>" class="form-control data" required>
              ...
              <div class="form-group col-12 col-md-6">
                ...
                <input type="cep" id="cep" name="cep" value="<?= htmlspecialchars($cliente[0]->cep)?>"  placeholder="C.E.P" class="form-control cep" title="Campo obrigatório" required>
              </div> <!-- FIM CEP -->
              <div class="form-group col-12 col-md-6">
            ...
            <div class="form-group col-12 col-md-6">
              ...
              <input type="bairro" id="bairro" name="bairro" value="<?= htmlspecialchars($cliente[0]->bairro)?>"  placeholder="Bairro" class="form-control" title="Campo obrigatório" required>
            </div> <!-- FIM BAIRRO -->
          <div class="form-group col-12 col-md-6">
          ...
          <div class="form-group col-12 col-md-6">
            ...
            <input type="complemento" id="complemento" name="complemento" value="<?= htmlspecialchars($cliente[0]->complemento)?>" placeholder="Complemento" class="form-control" title="Campo opcional" >
          </div> <!-- FIM COMPLEMENTO -->
