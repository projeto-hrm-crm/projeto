              ...
              <div class="card-body">
                ...
                <form action="<?php site_url('funcionario/edit'.$id); ?>" method="POST" class="form-horizontal">
                    ...
                    <div class="row form-group">
                      ...
                      <div class="col-12 col-md-9"><input type="text" id="telefone" name="telefone" value="<?= htmlspecialchars($funcionario[0]->telefone)?>" class="form-control" pattern="[0-9]{11}" title="Insira um número válido de telefone" ></div>
                    </div> <!-- FIM TELEFONE -->
